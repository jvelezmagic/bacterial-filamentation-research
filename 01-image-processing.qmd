...
statistical computation and plotting (see Chapter
...
| state          | Indicates the state of the cell determined from its length and fluorescence thresholds. -1 for death, 0 for normal, and 1 for filamentation (see Section \@ref(experiment-general-preprocessing) for detailed information). |
