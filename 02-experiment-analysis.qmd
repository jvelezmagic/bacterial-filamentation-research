...
```{r}
#| label: fig-proportion-living-cells-gfp-by-row-cap
...
GFP (see also @fig-gfp-temporal-distribution).
...
#|   for those cells with initial lengths and small. It seems to decrease with
