...
@sec-image-processing describes the fundamental process to identify and
quantify the properties of each cell over time, for example, its length,
the amount of internal toxin, and the amount of resistance to the toxin.
...
level. Data exploration allowed us to simultaneously observe the
