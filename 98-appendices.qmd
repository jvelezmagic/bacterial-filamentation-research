...
Below is the main list of packages used for @sec-experiment-analysis as
well for the reproducibility of this undergraduate research project.
...
This code base is using the `R Language` , `Quarto`, and `renv` to make
a reproducible scientific project named
